...
function adjustInputWidth() {
    const messageInput = document.getElementById('messageInput');
    const totalButtonWidth = document.getElementById('imageButton').offsetWidth + document.getElementById('sendButton').offsetWidth + 20;
    messageInput.style.width = `${document.querySelector('.chat-input').offsetWidth - totalButtonWidth}px`;
}
